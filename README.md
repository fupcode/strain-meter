...
在图像法测量应变的过程中，关键在于**准确识别样品在图像中的边缘位置**和**配准多个相似图像**，从而计算样品的长度变化以估算应变大小。
...
然而，想要测量出应变，就要测量不同样品同一位置的宽度或高度，这要求将不同图像进行配准，然而由于实验性质，样品在拉伸/拉曼激光下发生变化，使用特征点配准效果并不好，这里使用了模板匹配方法来旋转和配准。
